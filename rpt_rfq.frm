...
Call connect
main.lbltitle.Caption = "Request For Quotation"
...
WebBrowser.Navigate "About:Blank"
 ...
 inv.Open "select Distinct(rfqno) from requestquotation ", Cn, 3, 2 ' where status <> 'P'
 While Not inv.EOF
...
fs.WriteLine " <td width=617 height=37 align=center><font size=5><b>REQUEST FOR QUOTATION</b></td>"
fs.WriteLine " </tr>"
fs.WriteLine " </table>" 'header

Dim invpan As New ADODB.Recordset
If invpan.State Then invpan.Close
invpan.Open "select v.personincharge,v.name,v.address,r.rfqno,r.podate from requestquotation r,vendor v where r.vendor=v.name and r.rfqno='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine " <td width=143>&nbsp;&nbsp;&nbsp;<b>RFQ No:</b>&nbsp;&nbsp;&nbsp;" & invpan(3) & " <br>&nbsp;&nbsp;&nbsp;<b>RFQ Date:</b>&nbsp;" & Format(invpan(4), "dd/MMM/yyyy") & "</td>"
fs.WriteLine " </tr>"
...
invdet.Open "select * from requestquotation r,rfqdetails rd where r.rfqno=rd.rfqno and r.rfqno='" & cbo_invoice.Text & "' ", Cn, 3, 2
