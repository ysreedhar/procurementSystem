...
WebBrowser.Navigate "About:Blank"
 ...
 inv.Open "select Distinct(invoiceno) from invreceipt ", Cn, 3, 2 ' where status <> 'P'
 While Not inv.EOF
...
fs.WriteLine " <td width=617 height=37 align=center><font size=5><b>PURCHASE INVOICE</b></td>"
fs.WriteLine " </tr>"
fs.WriteLine " </table>" 'header

Dim invpan As New ADODB.Recordset
If invpan.State Then invpan.Close
invpan.Open "select v.personincharge,v.name,v.address,p.invoiceno,p.invdate from invreceipt p,vendor v where p.vendor=v.name and p.invoiceno='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine " <td width=382 >&nbsp;&nbsp;&nbsp;From:<b>" & invpan(0) & "</b> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & invpan(1) & "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & invpan(2) & "</td>"
fs.WriteLine " <td width=190>&nbsp;&nbsp;&nbsp;<b>Invoice No:</b>&nbsp;&nbsp;&nbsp;" & invpan(3) & " <br>&nbsp;&nbsp;&nbsp;<b>Invoice Date:</b>&nbsp;" & Format(invpan(4), "dd/MMM/yyyy") & "</td>"
fs.WriteLine " </tr>"
...
invdet.Open "select * from invreceipt p,invreceiptdetails pd where p.invoiceno=pd.invoiceno and p.invoiceno='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine "     <td align=right>&nbsp;" & Format(invdet!totamount, "###,###,##0.00") & "</td>"

qty = qty + invdet("qty")
urate = urate + invdet!amount
amt = amt + invdet!totamount
fs.WriteLine "   </tr>"
invdet.MoveNext
Wend
For i = 0 To (20 - rc)
...
fs.WriteLine "     <td colspan=3><b>Total </td>"
