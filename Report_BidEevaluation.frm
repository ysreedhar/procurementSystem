...
fs.WriteLine "  <tr bgcolor=black class=TableFont >"
fs.WriteLine "    <td Nowrap colspan=1><font color=white>Delivery Terms</td>"
fs.WriteLine "    <td nowrap colspan=1><font color=white>Delivery Period</td>"
fs.WriteLine "    <td nowrap colspan=1><font color=white>Payment Terms</td>"
fs.WriteLine "    <td nowrap colspan=1><font color=white>Quotation Validity</td>"
