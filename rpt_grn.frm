...
WebBrowser.Navigate "About:Blank"
 ...
 inv.Open "select Distinct(invoice) from delivery ", Cn, 3, 2 ' where status <> 'P'
 While Not inv.EOF
...
fs.WriteLine " <td width=617 height=37 align=center><font size=5><b>GOODS RECEIVED NOTE</b></td>"
fs.WriteLine " </tr>"
fs.WriteLine " </table>" 'header

Dim invpan As New ADODB.Recordset
If invpan.State Then invpan.Close
invpan.Open "select v.personincharge,v.name,v.address,p.invoice,p.deldate from delivery p,vendor v where p.vendor=v.name and p.invoice='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine " <td width=382 >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" & invpan(0) & "</b> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & invpan(1) & "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & invpan(2) & "</td>"
fs.WriteLine " <td width=190>&nbsp;&nbsp;&nbsp;<b>GRN No:</b>&nbsp;&nbsp;&nbsp;" & invpan(3) & " <br>&nbsp;&nbsp;&nbsp;<b>PO Date:</b>&nbsp;" & Format(invpan(4), "dd/MMM/yyyy") & "</td>"
fs.WriteLine " </tr>"
...
fs.WriteLine "   <td width=45 align=center><font color=white>BatchNo</td>"
...
invdet.Open "select * from delivery p,deliverydetails pd where p.invoice=pd.invoice and p.invoice='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine "     <td align=right>&nbsp;" & invdet!batchno & "</td>"
...
fs.WriteLine "     <td colspan=5><b>Total </td>"
