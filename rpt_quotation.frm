...
Begin VB.Form rpt_quotation 
   ...
   End
End
Attribute VB_Name = "rpt_quotation"
...
Call connect
main.lbltitle.Caption = "Quotation"
...
WebBrowser.Navigate "About:Blank"
 ...
 inv.Open "select Distinct(qno) from quotation ", Cn, 3, 2 ' where status <> 'P'
 While Not inv.EOF
...
fs.WriteLine " <td width=617 height=37 align=center><font size=5><b>QUOTATION</b></td>"
fs.WriteLine " </tr>"
fs.WriteLine " </table>" 'header

Dim invpan As New ADODB.Recordset
If invpan.State Then invpan.Close
invpan.Open "select v.personincharge,v.name,v.address,r.qno,r.podate from quotation r,vendor v where r.vendor=v.name and r.qno='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine " <td width=238>&nbsp;&nbsp;&nbsp;<b>Quot No:</b>&nbsp;&nbsp;&nbsp;" & invpan(3) & " <br>&nbsp;&nbsp;&nbsp;<b>Quot Date:</b>&nbsp;" & Format(invpan(4), "dd/MMM/yyyy") & "</td>"
fs.WriteLine " </tr>"
...
invdet.Open "select * from quotation r,quotationdetails rd where r.qno=rd.qno and r.qno='" & cbo_invoice.Text & "' ", Cn, 3, 2
