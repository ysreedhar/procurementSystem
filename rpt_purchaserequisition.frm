...
Begin VB.Form rpt_purchaserequisition 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   0  'None
   ClientHeight    =   9330
   ClientLeft      =   0
   ...
   End
End
Attribute VB_Name = "rpt_purchaserequisition"
...
WebBrowser.Navigate "About:Blank"
 ...
 inv.Open "select Distinct(prno) from purchaserequisition ", Cn, 3, 2 ' where status <> 'P'
 While Not inv.EOF
...
fs.WriteLine " <td width=618 height=37 align=center><font size=5 FAMILY=Times New Roman><b>PURCHASE REQUISITION</b></td>"
fs.WriteLine " </tr>"
fs.WriteLine " </table>" 'header

Dim invpan As New ADODB.Recordset
If invpan.State Then invpan.Close
invpan.Open "select * from purchaserequisition where prno ='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine " <td width=382 >&nbsp;&nbsp;&nbsp;&nbsp;Applicant:&nbsp;&nbsp;<b> " & invpan!indentor & "</b> <br>&nbsp;&nbsp;&nbsp;Department:&nbsp;" & invpan!department & "</td>"
fs.WriteLine " <td width=147>&nbsp;&nbsp;&nbsp;PR No.:&nbsp;&nbsp;&nbsp;" & invpan!prno & "<br>&nbsp;&nbsp;&nbsp;PR Date:&nbsp; " & invpan!prdate & "</td>"
fs.WriteLine " </tr>"
...
fs.WriteLine "  <tr bgcolor=gray class=TableFont bgcolor=black>"
fs.WriteLine "    <td width=33 height=29 align=center><font color=white> S.No</td>"
fs.WriteLine "    <td width=335><font color=white>&nbsp; Item description</td>"
fs.WriteLine "   <td width=47 align=center><font color=white>Reqd.Date</td>"
fs.WriteLine "    <td  width=47 align=center><font color=white>UOM</td>"
fs.WriteLine "    <td  width=47 align=center><font color=white>Qty</td>"
...
invdet.Open "select * from purchaserequisition p,prdetails pd where p.prno=pd.prno and p.prno='" & cbo_invoice.Text & "' ", Cn, 3, 2
...
fs.WriteLine "     <td align=center>" & invdet!reqdate & "</td>"
fs.WriteLine "     <td align=center>&nbsp;" & invdet!uom & "</td>"
fs.WriteLine "     <td align=center>&nbsp;" & invdet!qty & "</td>"
...
fs.WriteLine "     <td align=center><b>" & Format(qty, "###,###,##0.00") & "</td>"
